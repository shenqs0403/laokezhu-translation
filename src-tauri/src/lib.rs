...
use commands::{ get_all_engines,save_key_value,get_key_value,save_engine,is_wayland,translate_selected_text,open_translate_window};
...
pub fn run() {
    tauri::Builder::default()
        .setup(|app| {
            ...
            common::global_event_handler::register_mouse_event(app_handler)?;
        ...
        .invoke_handler(tauri::generate_handler![get_all_engines,save_key_value,get_key_value,save_engine,is_wayland,translate_selected_text,open_translate_window])
